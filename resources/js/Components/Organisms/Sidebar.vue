...
const dashboardRoute = computed(() => {
  return props.user?.has_admin_role ? '/admin/dashboard' : '/employee/dashboard'
})

const usersRoute = computed(() => {
  return props.user?.has_admin_role ? '/admin/users' : '/employee/users'
})

const employeesRoute = computed(() => {
  return props.user?.has_admin_role ? '/admin/employees' : '/employee/employees'
})
