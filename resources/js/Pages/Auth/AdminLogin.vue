<template>
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-900 via-purple-900 to-red-900 py-12 px-4 sm:px-6 lg:px-8">
        <!-- Background Pattern -->
        ...
        <div class="relative max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div class="mx-auto h-16 w-16 bg-gradient-to-r from-red-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    v-model="form.email"
                                    :class="[
                                        'block w-full pl-10 pr-3 py-3 border rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-sm text-white placeholder-gray-300',
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    :class="[
                                        'block w-full pl-10 pr-12 py-3 border rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 bg-white/10 backdrop-blur-sm text-white placeholder-gray-300',
            ...
            <div class="bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 p-6">
                ...
                <div class="text-xs text-gray-300 space-y-3">
                    <div class="bg-white/5 rounded-lg p-3 border border-white/10">
                        <p class="font-semibold text-red-300 mb-2">Admin Credentials</p>
                        <div class="space-y-2">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-400">
                    Not an admin? 
                    <a href="/employee/login" class="text-blue-400 hover:text-blue-300 font-medium">Employee Login</a>
                </p>
            </div>
        </div>
    </div>
...
const { loginAdmin, loading, errors } = useInertiaAuth()
